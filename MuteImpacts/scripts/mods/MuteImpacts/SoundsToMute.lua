...
mod.sounds_to_toggle = {
    ...
    melee_hits_blunt_no_damage = "wwise/events/weapon/play_melee_hits_blunt_no_damage",
    melee_hits_sword_no_damage = "wwise/events/weapon/play_melee_hits_sword_no_damage",
